package com.zhuangjie.websocket.util;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.zhuangjie.websocket.dto.output.ResultMessage;
...
public class MessageUtils {
    ...
    public static String getMessage(boolean systemMsgFlag, String fromName, Object message) {
        return getMessage(systemMsgFlag,null,fromName,message);
    }
    public static String getMessage(boolean systemMsgFlag,Integer code, String fromName, Object message) {
